...
# Model Selection (1)
if __name__ == '__main__':
    best_path = 'best_convnext.pt'
    checkpoint_path = 'convnext_chkpt.pth'
...
# Model Selection
if __name__ == '__main__':
    best_path2 = 'best_swin.pt'
    checkpoint_path2 = 'swin_chkpt.pth'
...
# Model Selection
if __name__ == '__main__':
    best_path3 = 'best_efficientnet.pt'
    checkpoint_path3 = 'efficientnet_chkpt.pth'
...
if __name__ == '__main__':
    ...
    model_state_dict = torch.load('best_convnext.pt',
                                  map_location = device)
...
if __name__ == '__main__':
    ...
    model2_state_dict = torch.load('best_swin.pt',
                                  map_location = device)
...
if __name__ == '__main__':
    ...
    model3_state_dict = torch.load('best_efficientnet.pt',
                                  map_location = device)
