...
### 분석 결과
* 상관 분석:
  * 구조로 인한 신고 건수는 기온, 습도, 바람과 약한 양의 상관 관계를 가져, 태풍의 영향으로 추정된다.
  * 화재로 인한 신고 건수는 습도와 약한 음의 상관 관계를 보여, 건조한 날씨의 영향이 큰 것으로 추정된다. 기온과 약한 양의 상관 관계를 가지는 것은 화재로 인한 기온 상승에 기인할 수 있다.
  * 구급과 기타 유형으로 인한 신고 건수는 유의미한 상관 관계를 보이지 않았다.
* 신고 건수 예측:
  * 양의 정수를 가지는 목표 변수에 대해 약 1.05의 평가 RMSE를 기록하였다.
