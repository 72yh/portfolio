...
* 기술 역량과 프로젝트 경험의 종합 요약은 저장소 최상위의 `PORTFOLIO.pdf`에서 확인하실 수 있습니다.

* 저장소 내 각 폴더는 포트폴리오에 기재된 프로젝트 제목과 동일한 이름으로 구성되어 있으며, 프로젝트 수행에 활용된 파이썬 코드(`.py`, `.ipynb`), 일부 경량 모델의 가중치 파일, 정형 데이터 등이 포함되어 있습니다.
