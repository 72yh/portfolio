...
* 국내 콘텐츠의 해외 소비에 대한 분석 사례는 많지만, 해외 콘텐츠의 국내 소비에 대한 분석 사례는 상대적으로 부족하다.

* 국내 작품만으로는 파악하기 어려운 한국 시장 고유의 감성을 해외 작품 분석을 통해 파악하고자 한다.

* 글로벌 성과 대비 국내 선호가 두드러지는 해외 영화의 리뷰를 분석하여 해당 감성을 도출하는 것을 목표로 한다.

### 주요 역할

* 프로젝트 후반에 합류하여, 이미 확정된 분석 제안서 범위 내에서 분석 오류를 수정하고 코드 구조를 재정비하였다.
...
* 국내 관객 수 기준 상위 300편 영화의 메타데이터와 106,460개 리뷰 텍스트를 수집하여 모형을 학습하였다.
...
* 변수 중요도:
  ...
  * 리뷰 측면에서 대형 IP('마블, '디즈니', ...), 음향, 부정 키워드의 중요도가 높게 나타났다.
 
* SHAP:

  * 예산이 클수록 국내 특화와는 거리가 먼 것으로 나타났다. 이는 예산이 큰 웰메이드 영화가 국내에서 흥행하지 못해서가 아니라, 어느 나라에서든 흥행하는 보편적 콘텐츠일 가능성이 높기 때문이다.
 
  * 해외에 비해 국내 시장은 스릴러 장르를 더 선호한다.
...
* 결론:
  ...
  * 대형 IP는 국내 특화형과는 거리가 멀다. 반대로 글로벌 시장에 대응하려면 IP가 필수적이다. 글로벌 시장을 목표로 한다면 초기 기획 단계에서 장기적 IP 투자와 트랜스미디어 전략 수립이 권장된다.
